...
const isOpenDeleteModal = toRef(props, 'isOpenDeleteModal');
const gameName = toRef(props, 'gameName');

const emit = defineEmits(['close-modal', 'delete-game']);
                    ...
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-200">
                                Are you sure to delete {{ gameName }} game?
                            </DialogTitle>

                            <div class="flex flex-row items-center justify-center gap-2 mt-4">
                                <button type="button"
                                    class="inline-flex justify-center px-4 py-2 text-sm font-medium text-red-900 bg-red-200 border border-transparent rounded-md hover:bg-red-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                                    @click="deleteGame">
                                    Delete
                                </button>
                                <button type="button"
